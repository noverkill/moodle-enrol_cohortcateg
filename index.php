...
echo $OUTPUT->heading('Created cohorts' . $count);
...
$baseurl = new moodle_url('/enrol/cohortcateg/index.php', $params);
echo $OUTPUT->paging_bar($cohorts['totalcohorts'], $page, $perpage, $baseurl);
